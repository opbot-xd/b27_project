...
func RegisterNewUser(username, password string) error {
	...
	//sets key value pair of username and password
	...
	//adds username to list of registered users Redis Set
...
func IsUserExist(username string) bool {
	...
	//checks the keys if existing user exists
...
func IsUserAuthentic(username, password string) error {
	...
	//gets the value of password based of username passed as key and matches the passwords
